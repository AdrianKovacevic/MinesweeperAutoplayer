...
public class Cell {
    ...
    /**
     * The constructor of a Cell states that its row and column must be given, as well as its value, as this
     * information is always present when reading a cell at a certain position
     *
     * @param cellValue The value of the cell, CELL_ONE to CELL_SEVEN for numbers, CELL_FLAG for a flag,
     *                  CELL_BLANK for a blank cell that would have 0 mines around it, and CELL_UNKNOWN for a cell which
